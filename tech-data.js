...
window.techData = {
  techs: [
    ...
    { id: "TECH_BATTLELINE", name: "Battleline", cost: 700, column: 4, row: 7, prereqs: ["TECH_PHALANX", "TECH_STEEL"], unlocks: { units: ["Maceman"], improvements: [], laws: [], projects: [] } },
  ...
  bonusTechs: [
    { id: "TECH_STONECUTTING_BONUS_STONE", name: "Stone Boost", cost: 50, parent: "TECH_STONECUTTING", bonus: "+200 Stone" },
    { id: "TECH_ADMINISTRATION_BONUS_WORKER", name: "Free Worker", cost: 50, parent: "TECH_ADMINISTRATION", bonus: "+1 Worker" },
    { id: "TECH_HUSBANDRY_BONUS_FOOD", name: "Food Boost", cost: 75, parent: "TECH_HUSBANDRY", bonus: "+200 Food" },
    { id: "TECH_DRAMA_BONUS_SETTLER", name: "Free Settler", cost: 75, parent: "TECH_DRAMA", bonus: "+1 Settler" },
    { id: "TECH_ARISTOCRACY_BONUS_BORDERS", name: "Border Boost", cost: 75, parent: "TECH_ARISTOCRACY", bonus: "Border Growth" },
    { id: "TECH_NAVIGATION_BONUS_BIREME", name: "Free Bireme", cost: 125, parent: "TECH_STEEL", bonus: "+1 Bireme" },
    { id: "TECH_PHALANX_BONUS_ORDERS", name: "Orders Boost", cost: 125, parent: "TECH_PHALANX", bonus: "+20 Orders" },
    { id: "TECH_SPOKED_WHEEL_BONUS_CHARIOT", name: "Free Chariot", cost: 125, parent: "TECH_SOVEREIGNTY", bonus: "+1 Chariot" },
    { id: "TECH_FORESTRY_BONUS_SCIENTIST", name: "Free Scientist", cost: 125, parent: "TECH_METAPHYSICS", bonus: "Free Scientist" },
    { id: "TECH_STEEL_BONUS_TRAINING", name: "Training Boost", cost: 125, parent: "TECH_STEEL", bonus: "+800 Training" },
    { id: "TECH_SOVEREIGNITY_BONUS_CIVICS", name: "Civics Boost", cost: 125, parent: "TECH_SOVEREIGNTY", bonus: "+800 Civics" },
    { id: "TECH_COINAGE_BONUS_MONEY", name: "Money Boost", cost: 200, parent: "TECH_COINAGE", bonus: "+4000 Money" },
    ...
    { id: "TECH_COMPOSITE_BOW_BONUS_ARCHER", name: "Free Archer", cost: 125, parent: "TECH_FORESTRY", bonus: "+1 Archer" },
    { id: "TECH_MACHINERY_BONUS_ONAGER", name: "Free Onager", cost: 200, parent: "TECH_PORTCULLIS", bonus: "+1 Onager" },
    { id: "TECH_SCHOLARSHIP_BONUS_SCIENTIST", name: "Free Scientist", cost: 350, parent: "TECH_SCHOLARSHIP", bonus: "Free Scientist" },
    { id: "TECH_STIRRUPS_BONUS_HORSEMAN", name: "Free Horseman", cost: 200, parent: "TECH_LAND_CONSOLIDATION", bonus: "+1 Horseman" },
    { id: "TECH_STIRRUPS_BONUS_HORSE_ARCHER", name: "Free Horse Archer", cost: 200, parent: "TECH_COMPOSITE_BOW", bonus: "+1 Horse Archer" },
    { id: "TECH_MANOR_BONUS_GOODS", name: "Goods Bonus", cost: 200, parent: "TECH_MACHINERY", bonus: "Luxury Goods" },
    { id: "TECH_BATTLELINE_BONUS_SOLDIER", name: "Free Court Soldier", cost: 350, parent: "TECH_BATTLELINE", bonus: "Free Court Soldier" },
    { id: "TECH_HYDRAULICS_BONUS_BALLISTA", name: "Free Ballista", cost: 200, parent: "TECH_COMPOSITE_BOW", bonus: "+1 Ballista" },
    { id: "TECH_JURISPRUDENCE_BONUS_MINISTER", name: "Free Minister", cost: 550, parent: "TECH_JURISPRUDENCE", bonus: "+1 Minister" },
    { id: "TECH_VAULTING_BONUS_HAPPINESS", name: "Happiness Boost", cost: 350, parent: "TECH_VAULTING", bonus: "Happiness Boost" },
    { id: "TECH_BODKIN_ARROW_BONUS_LONGBOWMAN", name: "Free Longbowman", cost: 350, parent: "TECH_BATTLELINE", bonus: "+2 Longbowman" },
    { id: "TECH_FISCAL_POLICY_BONUS_MERCHANT", name: "Free Merchant", cost: 350, parent: "TECH_MANOR", bonus: "Free Merchant" },
    { id: "TECH_INFANTRY_SQUARE_BONUS_SOLDIER", name: "Free Court Soldier", cost: 350, parent: "TECH_STIRRUPS", bonus: "Free Court Soldier" },
    { id: "TECH_CHAIN_DRIVE_BONUS_MERCHANT", name: "Free Merchant", cost: 350, parent: "TECH_CARTOGRAPHY", bonus: "Free Merchant" },
    { id: "TECH_BATTERING_RAM_BONUS", name: "Free Battering Ram", cost: 250, parent: "", bonus: "+2 Battering Ram", nation: "NATION_ASSYRIA", cultureRequired: "CULTURE_STRONG" },
    { id: "TECH_SIEGE_TOWER_BONUS", name: "Free Siege Tower", cost: 700, parent: "", bonus: "+2 Siege Tower", nation: "NATION_ASSYRIA", cultureRequired: "CULTURE_LEGENDARY" },
    { id: "TECH_AKKADIAN_ARCHER_BONUS", name: "Free Akkadian Archer", cost: 250, parent: "", bonus: "+2 Akkadian Archer", nation: "NATION_BABYLONIA", cultureRequired: "CULTURE_STRONG" },
    { id: "TECH_CIMMERIAN_ARCHER_BONUS", name: "Free Cimmerian Archer", cost: 700, parent: "", bonus: "+2 Cimmerian Archer", nation: "NATION_BABYLONIA", cultureRequired: "CULTURE_LEGENDARY" },
    { id: "TECH_AFRICAN_ELEPHANT_BONUS", name: "Free African Elephant", cost: 250, parent: "", bonus: "+2 African Elephant", nation: "NATION_CARTHAGE", cultureRequired: "CULTURE_STRONG" },
    { id: "TECH_TURRETED_ELEPHANT_BONUS", name: "Free Turreted Elephant", cost: 700, parent: "", bonus: "+2 Turreted Elephant", nation: "NATION_CARTHAGE", cultureRequired: "CULTURE_LEGENDARY" },
    { id: "TECH_LIGHT_CHARIOT_BONUS", name: "Free Light Chariot", cost: 250, parent: "", bonus: "+2 Light Chariot", nation: "NATION_EGYPT", cultureRequired: "CULTURE_STRONG" },
    { id: "TECH_MOUNTED_LANCER_BONUS", name: "Free Mounted Lancer", cost: 700, parent: "", bonus: "+2 Mounted Lancer", nation: "NATION_EGYPT", cultureRequired: "CULTURE_LEGENDARY" },
    { id: "TECH_HOPLITE_BONUS", name: "Free Hoplite", cost: 250, parent: "", bonus: "+2 Hoplite", nation: "NATION_GREECE", cultureRequired: "CULTURE_STRONG" },
    { id: "TECH_PHALANGITE_BONUS", name: "Free Phalangite", cost: 700, parent: "", bonus: "+2 Phalangite", nation: "NATION_GREECE", cultureRequired: "CULTURE_LEGENDARY" },
    { id: "TECH_PALTON_CAVALRY_BONUS", name: "Free Palton Cavalry", cost: 250, parent: "", bonus: "+2 Palton Cavalry", nation: "NATION_PERSIA", cultureRequired: "CULTURE_STRONG" },
    { id: "TECH_CATAPHRACT_ARCHER_BONUS", name: "Free Cataphract Archer", cost: 700, parent: "", bonus: "+2 Cataphract Archer", nation: "NATION_PERSIA", cultureRequired: "CULTURE_LEGENDARY" },
    { id: "TECH_HASTATUS_BONUS", name: "Free Hastatus", cost: 250, parent: "", bonus: "+2 Hastatus", nation: "NATION_ROME", cultureRequired: "CULTURE_STRONG" },
    { id: "TECH_LEGIONARY_BONUS", name: "Free Legionary", cost: 700, parent: "", bonus: "+2 Legionary", nation: "NATION_ROME", cultureRequired: "CULTURE_LEGENDARY" },
    { id: "TECH_HITTITE_CHARIOT_1_BONUS", name: "Free Hittite Chariot", cost: 250, parent: "", bonus: "+2 Hittite Chariot", nation: "NATION_HITTITE", cultureRequired: "CULTURE_STRONG" },
    { id: "TECH_HITTITE_CHARIOT_2_BONUS", name: "Free Hittite Chariot", cost: 700, parent: "", bonus: "+2 Hittite Chariot", nation: "NATION_HITTITE", cultureRequired: "CULTURE_LEGENDARY" },
    { id: "TECH_MEDJAY_ARCHER_BONUS", name: "Free Medjay", cost: 250, parent: "", bonus: "+2 Medjay", nation: "NATION_KUSH", cultureRequired: "CULTURE_STRONG" },
    { id: "TECH_BEJA_ARCHER_BONUS", name: "Free Beja Archer", cost: 700, parent: "", bonus: "+2 Beja Archer", nation: "NATION_KUSH", cultureRequired: "CULTURE_LEGENDARY" },
    { id: "TECH_DMT_WARRIOR_BONUS", name: "Free Dmt Warrior", cost: 250, parent: "", bonus: "+2 Dmt Warrior", nation: "NATION_AKSUM", cultureRequired: "CULTURE_STRONG" },
    { id: "TECH_SHOTELAI_BONUS", name: "Free Shotelai", cost: 700, parent: "", bonus: "+2 Shotelai", nation: "NATION_AKSUM", cultureRequired: "CULTURE_LEGENDARY" },
    { id: "TECH_RESOURCE_PORCELAIN_BONUS", name: "Porcelain", cost: 200, parent: "TECH_COINAGE", bonus: "Porcelain" },
    { id: "TECH_RESOURCE_EXOTIC_FUR_BONUS", name: "Exotic Furs", cost: 125, parent: "TECH_SPOKED_WHEEL", bonus: "Exotic Furs" },
    { id: "TECH_RESOURCE_PERFUME_BONUS", name: "Perfume", cost: 200, parent: "TECH_ARCHITECTURE", bonus: "Perfume" },
    { id: "TECH_MAURYA_ASSAULT_ELEPHANT_BONUS", name: "Free Assault Elephant", cost: 250, parent: "", bonus: "+1 Assault Elephant", nation: "NATION_MAURYA", cultureRequired: "CULTURE_STRONG" },
    { id: "TECH_MAURYA_ARMOURED_ELEPHANT_BONUS", name: "Free Armoured Elephant", cost: 700, parent: "", bonus: "+2 Armoured Elephant", nation: "NATION_MAURYA", cultureRequired: "CULTURE_LEGENDARY" },
    { id: "TECH_YUEZHI_STEPPE_RIDERS_BONUS", name: "Free Steppe Riders", cost: 100, parent: "", bonus: "+2 Steppe Riders", nation: "NATION_YUEZHI", cultureRequired: "CULTURE_DEVELOPING" },
    { id: "TECH_YUEZHI_KUSHAN_CAVALRY_BONUS", name: "Free Kushan Cavalry", cost: 250, parent: "", bonus: "+2 Kushan Cavalry", nation: "NATION_YUEZHI", cultureRequired: "CULTURE_STRONG" },
    { id: "TECH_YUEZHI_KUSHAN_WARLORD_BONUS", name: "Free Kushan Warlord", cost: 700, parent: "", bonus: "+2 Kushan Warlord", nation: "NATION_YUEZHI", cultureRequired: "CULTURE_LEGENDARY" },
    { id: "TECH_TAMIL_JAVELIN_ELEPHANT_BONUS", name: "Free Javelin Elephant", cost: 250, parent: "", bonus: "+2 Javelin Elephant", nation: "NATION_TAMIL", cultureRequired: "CULTURE_STRONG" },
    { id: "TECH_TAMIL_ARCHER_ELEPHANT_BONUS", name: "Free Archer Elephant", cost: 700, parent: "", bonus: "+2 Archer Elephant", nation: "NATION_TAMIL", cultureRequired: "CULTURE_LEGENDARY" }
  ]
};
