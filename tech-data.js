...
window.techData = {
  ...
  bonusTechs: [
    ...
    { id: "TECH_DMT_WARRIOR_BONUS", name: "Free D'mt Warrior", cost: 250, parent: "", bonus: "This bonus grants free D'mt Warrior Units in your Capital. A melee Unittrait Infantry Unit that is unique to Aksum, the D'mt Warrior will Effectdisarm its target, temporarily lowering their Strength for any future attacks.", nation: "NATION_AKSUM", cultureRequired: "CULTURE_STRONG", iconName: "BONUS_DMT_WARRIOR" },
    { id: "TECH_SHOTELAI_BONUS", name: "Free Shotelai", cost: 700, parent: "", bonus: "This bonus grants free Shotelai Units in your Capital. A melee Unittrait Infantry Unit that is unique to Aksum, the Shotelai will Effectdisarm its target, temporarily lowering their Strength for any future attacks.", nation: "NATION_AKSUM", cultureRequired: "CULTURE_LEGENDARY", iconName: "BONUS_SHOTELAI" },
    ...
    { id: "TECH_MAURYA_ASSAULT_ELEPHANT_BONUS", name: "Free Assault Elephant", cost: 250, parent: "", bonus: "This bonus grants free Assault Elephant Units in your Capital. A mounted Unit that is unique to Maurya, the Assault Elephant is especially strong when attacking Cities and other Urban Tiles.", nation: "NATION_MAURYA", cultureRequired: "CULTURE_STRONG", iconName: "BONUS_ASSAULT_ELEPHANT" },
    { id: "TECH_MAURYA_ARMOURED_ELEPHANT_BONUS", name: "Free Armored Elephant", cost: 700, parent: "", bonus: "This bonus grants free Armored Elephant Units in your Capital. A mounted Unit that is unique to Maurya, the Armored Elephant is especially strong when attacking Cities and other Urban Tiles.", nation: "NATION_MAURYA", cultureRequired: "CULTURE_LEGENDARY", iconName: "BONUS_ARMORED_ELEPHANT" },
    { id: "TECH_YUEZHI_STEPPE_RIDERS_BONUS", name: "Free Steppe Rider", cost: 100, parent: "", bonus: "This bonus grants free Steppe Rider Units in your Capital. A cheap and weak mounted Unit unique to Yuezhi, the Steppe Rider are fast horse archers, good for exploring and attacking in numbers.", nation: "NATION_YUEZHI", cultureRequired: "CULTURE_DEVELOPING", iconName: "BONUS_STEPPE_RIDER" },
    { id: "TECH_YUEZHI_KUSHAN_CAVALRY_BONUS", name: "Free Kushan Cavalry", cost: 250, parent: "", bonus: "This bonus grants free Kushan Cavalry Units in your Capital. A mounted heavy cavalry Unit that is unique to Yuezhi, the Kushan Cavalry can activate their Charge effect to get a bonus to attack at the cost of defense.", nation: "NATION_YUEZHI", cultureRequired: "CULTURE_STRONG", iconName: "BONUS_KUSHAN_CAVALR" },
    { id: "TECH_YUEZHI_KUSHAN_WARLORD_BONUS", name: "Free Kushan Warlord", cost: 700, parent: "", bonus: "This bonus grants free Kushan Warlord Units in your Capital. A mounted heavy cavalry Unit that is unique to Yuezhi, the Kushan Warlord can activate their Charge effect to get a bonus to attack at the cost of defense.", nation: "NATION_YUEZHI", cultureRequired: "CULTURE_LEGENDARY", iconName: "BONUS_KUSHAN_WARLORD" },
    { id: "TECH_TAMIL_JAVELIN_ELEPHANT_BONUS", name: "Free Javelin Elephant", cost: 250, parent: "", bonus: "This bonus grants free Javelin Elephant Units in your Capital. A mounted Unit that is unique to Tamilakam, the Javelin Elephant is a ranged elephant unit that debuffs enemies it attacks.", nation: "NATION_TAMIL", cultureRequired: "CULTURE_STRONG", iconName: "BONUS_JAVELIN_ELEPHANT" },
    { id: "TECH_TAMIL_ARCHER_ELEPHANT_BONUS", name: "Free Elephant Archer", cost: 700, parent: "", bonus: "This bonus grants free Elephant Archer Units in your Capital. A mounted Unit that is unique to Tamilakam, the Elephant Archer is a ranged elephant unit that debuffs enemies it attacks.", nation: "NATION_TAMIL", cultureRequired: "CULTURE_LEGENDARY", iconName: "BONUS_ARCHER_ELEPHANT" }
  ]
};
